...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => UpdateProfileStatusUseCase(userServiceRepository: sl()));
  ...
  /// order module
  sl.registerFactory(() => BookingBloc(getAllOrderUseCase: sl(),addOrderUseCase: sl(),updateOrderUseCase: sl(),sendRequestUseCase: sl()));
  ...
  sl.registerFactory(() => CategoriesBloc(getAllCategoryUseCase: sl(),getAllSlidersUseCase: sl(),getAllAllergiesUseCase: sl(), getAllPublicationsUseCase: sl()));
  sl.registerLazySingleton(() => GetAllCategoryUseCase(categoryRepository: sl()));
  sl.registerLazySingleton(() => GetAllAllergiesUseCase(categoryRepository: sl()));
  sl.registerLazySingleton(() => GetAllSlidersUseCase(categoryRepository: sl()));
  sl.registerLazySingleton(() => GetAllPublicationsUseCase(categoryRepository: sl()));
  ...
  sl.registerFactory(() => NurseBloc(getAllNursesUseCase: sl(),rateNurseUseCase: sl()));
  ...
  sl.registerLazySingleton<NursesRepository>(() => NursesModelRepository(networkInfo: sl(), nursesRemoteDataSourceImpl: sl()));
  sl.registerLazySingleton<NursesRemoteDataSourceImpl>(() => NursesRemoteDataSource(client: sl()));
