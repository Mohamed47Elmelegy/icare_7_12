...
class UpdateNurseDataEvent extends AccountEvent{
  ...
  const UpdateNurseDataEvent({this.nurse,
    this.license, this.certificate, this.nurseID,
    this.associationCard,this.relatedJobId,this.avatar,
    this.educationList,this.coursesList,this.publicationsList,
    this.languageList,this.servicesList,this.emergencyContactsList
  });
}
