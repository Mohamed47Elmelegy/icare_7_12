    ...
    return Column(
      children: [
        ...
        ItemLineDrawer(
          ...
          icon: Icon(Icons.add_circle_outline,size: 20.w,color: DMUtil.getPC2()),
          fn: (){
            Scaffold.of(ctx).closeDrawer();
            RootBloc.get(context).add(const ChangeIndex(index: 0, title: ""));
          },
        ...
        ItemLineDrawer(
          ...
          icon: Icon(Icons.file_copy_outlined,size: 20.w,color: DMUtil.getPC2()),
          fn: (){
            Scaffold.of(ctx).closeDrawer();
            RootBloc.get(context).add(const ChangeIndex(index: 0, title: ""));
          },
        ...
        ItemLineDrawer(
          ...
          icon: NotificationIcon(color: DMUtil.getPC2(),),
          fn: (){
            Scaffold.of(ctx).closeDrawer();
            RootBloc.get(context).add(const ChangeIndex(index: 0, title: ""));
        ...
        ItemLineDrawer(
          ...
          icon: Icon(Icons.payment,color: DMUtil.getPC2(),),
          fn: (){
            Scaffold.of(ctx).closeDrawer();
            RootBloc.get(context).add(const ChangeIndex(index: 0, title: ""));
          },
        ...
        ItemLineDrawer(
          ...
          icon: Icon(Icons.account_box_outlined,color: DMUtil.getPC2(),),
          fn: (){
            Scaffold.of(ctx).closeDrawer();
        ...
        if(Util.checkUser())...[
          ItemLineDrawer(
            ...
            icon: Icon(Icons.logout,size: 20.w,color: DMUtil.getPC2().withOpacity(0.7),),
            fn: (){
              Scaffold.of(ctx).closeDrawer();
