...
class CreateNurseAccountScreen extends StatelessWidget {
  ...
  static final TextEditingController licenceTextEditingController = TextEditingController();
  static final TextEditingController certificateTextEditingController = TextEditingController();
  static final TextEditingController nurseIDTextEditingController = TextEditingController();
  static final TextEditingController associateTextEditingController = TextEditingController();
  static final TextEditingController relatedJobCardTextEditingController = TextEditingController();
  @override
            ...
            return CustomButton(
              ...
              widget: Row(
                ...
                children: [
                  ...
                  Icon(Icons.arrow_forward_outlined,size: 20.w,color: DMUtil.getWC(),),
                ],
              ),
              color: DMUtil.getPC(),
              onPressed: ()async{
                if(bloc.avatar==null){
                  SnackBarBuilder.showFeedBackMessage(context, translate("toast.img_missing"), Colors.red);
                  return false;
                }
                if(validateForm(context: context,bloc: bloc)){
                  bloc.add(UpdateNurseRegisterDataEvent(nurse: NurseEntity(
                    id: 0,
                  ...
                  Util.pushPage(const CompleteNurseRegisterDataScreen(), context);
                }else{
        ...
        body: BlocListener<AuthBloc,AuthState>(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                const AppBarNurseCreateAccount(showCircleImg: true,),
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      NurseType(txtColor: DMUtil.getD2C(),),
                      ...
                      Stack(
                        ...
                        children: [
                          CustomTextFromField(
                            ...
                            labelText: '',
                            height: 46,
                            hintText: translate("nurse.nurse_id"),
                            radius: 10,
                            onChanged: (val){},
                            onFieldSubmitted: (val){},
                          ...
                          InkWell(
                            onTap: ()async{
                              ...
                              if(file!=null){
                                nurseIDTextEditingController.text = _getFileName(file);
                                AuthBloc.get(context).add(UpdateNurseRegisterDataEvent(nurseID: file));
                              }
                            },
                                  ...
                                  Stack(
                                    ...
                                    children: [
                                      CustomTextFromField(
                                        ...
                                        onChanged: (val){},
                                        onFieldSubmitted: (val){},
                                        textEditingController: relatedJobCardTextEditingController,
                                        enabled: false,
                                        cursorColor: kPrimary,
                                        validator: () {},
                                        prefixIcon: null,
                                      ...
                                      InkWell(
                                        onTap: ()async{
                                          ...
                                          final file = await cropImage(res);
                                          if(file!=null){
                                            relatedJobCardTextEditingController.text = _getFileName(file);
                                            AuthBloc.get(context).add(UpdateNurseRegisterDataEvent(relatedJobId: file));
                                          }
                                        },
                                        child: const UploadWidget(),
                                      ),
                                  ...
                                  Stack(
                                    ...
                                    children: [
                                      CustomTextFromField(
                                        ...
                                        onChanged: (val){},
                                        onFieldSubmitted: (val){},
                                        textEditingController: licenceTextEditingController,
                                        enabled: false,
                                        cursorColor: kPrimary,
                                        validator: () {},
                                        prefixIcon: null,
                                      ...
                                      InkWell(
                                        onTap: ()async{
                                          ...
                                          final file = await cropImage(res);
                                          if(file!=null){
                                            licenceTextEditingController.text = _getFileName(file);
                                            AuthBloc.get(context).add(UpdateNurseRegisterDataEvent(license: file));
                                          }
                                        },
                                        child: const UploadWidget(),
                                      ),
                                  ...
                                  Stack(
                                    ...
                                    children: [
                                      CustomTextFromField(
                                        ...
                                        onChanged: (val){},
                                        onFieldSubmitted: (val){},
                                        textEditingController: certificateTextEditingController,
                                        cursorColor: kPrimary,
                                        enabled: false,
                                        validator: () {},
                                        prefixIcon: null,
                                      ...
                                      InkWell(
                                        onTap: ()async{
                                          ...
                                          final file = await cropImage(res);
                                          if(file!=null){
                                            certificateTextEditingController.text = _getFileName(file);
                                            AuthBloc.get(context).add(UpdateNurseRegisterDataEvent(certificate: file));
                                          }
                                        },
                                        child: const UploadWidget(),
                                      ),
                                  ...
                                  Stack(
                                    ...
                                    children: [
                                      CustomTextFromField(
                                        ...
                                        labelText: '',
                                        height: 45,
                                        hintText: translate("nurse.association_card"),
                                        radius: 10,
                                        onChanged: (val){},
                                        onFieldSubmitted: (val){},
                                        textEditingController: associateTextEditingController,
                                        cursorColor: kPrimary,
                                        enabled: false,
                                        validator: () {},
                                        prefixIcon: null,
                                      ...
                                      InkWell(
                                        onTap: ()async{
                                          ...
                                          final file = await cropImage(res);
                                          if(file!=null){
                                            associateTextEditingController.text = _getFileName(file);
                                            AuthBloc.get(context).add(UpdateNurseRegisterDataEvent(associationCard: file));
                                          }
                                        },
                                        child: const UploadWidget(),
                                      ),
  ...
  validateForm({BuildContext? context,required AuthBloc bloc}){
    ...
    if(bloc.isNurse){
      if(associateTextEditingController.text.isEmpty||licenceTextEditingController.text.isEmpty||
          certificateTextEditingController.text.isEmpty)return false;
