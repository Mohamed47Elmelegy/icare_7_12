  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: BlocListener<BookingBloc,BookingState>(
        ...
        listenWhen: (previous, current) => current is UpdateOrderSuccessfullyState || current is RefuesdOrderSuccessfullyState || current is OrderErrorState,
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
            ConfirmBookingRequestBtn(orderID: item.orderId.toString(),),
            RefusedBookingRequestBtn(orderID: item.orderId.toString(),),
          ],
        ),
      )
    );
