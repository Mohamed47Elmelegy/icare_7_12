...
class ShippingAddress extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if(cityTextEditingController.text.isEmpty)cityTextEditingController.text = Util.getCity();
    if(addressTextEditingController.text.isEmpty)addressTextEditingController.text = Util.getAddress();
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            CustomText(text: translate('order.shipping_details'), color: kPrimary, fontSize: AppStyle.average.sp),
            ...
            CustomButton(
              ...
              color: kPrimary,
              onPressed: (){
                if(addressTextEditingController.text.trim().isNotEmpty&&cityTextEditingController.text.trim().isNotEmpty){
