...
class RequestForm extends StatelessWidget {
  ...
  static final TextEditingController nationalIDTextEditingController = TextEditingController();
  ...
  static final TextEditingController mainMedicalTextEditingController = TextEditingController();
  static final TextEditingController moreInfoMedicalTextEditingController = TextEditingController();
  static final TextEditingController phoneTextEditingController = TextEditingController();
  static final TextEditingController numberTextEditingController = TextEditingController();
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextFromField(
                  ...
                  radius: 10,
                  onChanged: (val)=> BookingBloc.get(context).add(UpdateRequestFormDataEvent(data: {'full_name':val.toString()})),
                ...
                CustomTextFromField(
                  ...
                  radius: 10,
                  onChanged: (val)=> BookingBloc.get(context).add(UpdateRequestFormDataEvent(data: {'national_id':val.toString()})),
                  onFieldSubmitted: (val){},
                ...
                CustomTextFromField(
                  ...
                  radius: 10,
                  onChanged: (val)=> BookingBloc.get(context).add(UpdateRequestFormDataEvent(data: {'main_medical':val.toString()})),
                  onFieldSubmitted: (val){},
                  textInputType: TextInputType.text,
                ...
                CustomTextFromField(
                  ...
                  radius: 10,
                  onChanged: (val)=> BookingBloc.get(context).add(UpdateRequestFormDataEvent(data: {'phone':val.toString()})),
                  onFieldSubmitted: (val){},
                  textInputType: TextInputType.phone,
                  ...
                  children: [
                    Expanded(
                      child: CustomTextFromField(
                        ...
                        hintText: '1',
                        radius: 10,
                        onChanged: (val)=> BookingBloc.get(context).add(UpdateRequestFormDataEvent(data: {'range_number':val.toString()})),
                        onFieldSubmitted: (val){},
                ...
                CustomTextFromField(
                  ...
                  radius: 10,
                  maxLines: 3,
                  onChanged: (val)=> BookingBloc.get(context).add(UpdateRequestFormDataEvent(data: {'more_info':val.toString()})),
                  onFieldSubmitted: (val){},
                  textInputType: TextInputType.text,
