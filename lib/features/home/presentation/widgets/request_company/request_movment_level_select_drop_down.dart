      ...
      child: BlocBuilder<BookingBloc,BookingState>(
        builder: (ctx,state){
          ...
          return DropdownButton<String>(
            ...
            onChanged: (String? newValue) => bloc.add(UpdateRequestFormDataEvent(data: {'movment_level': newValue.toString()})),
            items: ['قادر علي الحركه','محدود الحركة','غير قادر علي الحركة'].map<DropdownMenuItem<String>>((value) {
