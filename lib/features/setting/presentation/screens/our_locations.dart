      ...
      body: BlocBuilder<RootBloc, RootState>(
        builder: (ctx, state) {
          ...
          return ListView.separated(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              CustomText(
                                text:
                                    "${translate("activity_setting.from")} 9 ${translate("activity_setting.am")} ${translate("activity_setting.to")} 11 ${translate("activity_setting.pm")}",
                                color: DMUtil.getD2C(),
                                fontSize: AppStyle.small.sp,
                              ),
                              if (item.address1.contains("الخبر") ||
                                  item.address1.contains("elhob")) ...[
                                const SizedBox(
                                  height: 4,
                                ),
                                CustomText(
                                    text:
                                        "${translate("activity_setting.closed_friday")} *",
                                    color: DMUtil.getRED(),
                                    fontSize: AppStyle.small.sp),
                              ],
                            ],
            ...
            separatorBuilder: (ctx, state) => SizedBox(
              height: 12.w,
            ),
