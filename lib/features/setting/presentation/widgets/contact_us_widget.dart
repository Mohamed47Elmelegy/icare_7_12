  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          SmallWidget(
            title: translate("drawer.whats"),
            img: AppImages.whats,
            onTap: () => Util.sendWhatsApp("+966920003240"),
          ),
          SmallWidget(
            title: translate("drawer.support"),
            img: AppImages.support,
            onTap: () => Util.call("8002446660"),
          ),
          SmallWidget(
            title: translate("drawer.contact"),
            img: AppImages.mail,
            onTap: () => Util.pushPage(const ContactScreen(), context),
          ),
        ],
      ),
    );
