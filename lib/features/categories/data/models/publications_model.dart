...
class PublicationsModel extends PublicationsEntity {
  const PublicationsModel({required super.id, required super.title, required super.imgUrl, required super.videoUrl});
  ...
  static List<PublicationsModel> listFromJson(String str) =>
      List<PublicationsModel>.from(json.decode(str).map((x) => PublicationsModel.fromJson(x)));
