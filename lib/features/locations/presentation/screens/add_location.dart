...
class AddNewLocationScreen extends StatefulWidget {
  ...
  const AddNewLocationScreen(
      {super.key, this.locationEntity, this.type = "shipping"});
...
class _AddNewLocationScreenState extends State<AddNewLocationScreen> {
  ...
  final TextEditingController streetTextEditingController =
      TextEditingController();
  final TextEditingController areaTextEditingController =
      TextEditingController();
  final TextEditingController flatNumberTextEditingController =
      TextEditingController();
  final TextEditingController buildingNumberTextEditingController =
      TextEditingController();
  final TextEditingController postCodeNumberTextEditingController =
      TextEditingController();
  ...
  void didChangeDependencies() {
    ...
    if (widget.locationEntity != null) {
      locationMapEntity = LocationMapEntity(
          lat: widget.locationEntity!.lat,
          long: widget.locationEntity!.long,
          address: widget.locationEntity!.address2,
          city: widget.locationEntity!.address1,
          country: widget.locationEntity!.country,
          postalCode: widget.locationEntity!.postCode.toString(),
      ...
      locationsBloc
          .add(UpdateCurrentLocationEvent(location: widget.locationEntity!));
    } else {
      _goToMap();
    }
  ...
  _goToMap() async {
    ...
    final res = await Util.pushPage(
        MapScreen(isSet: true, title: translate("map.select_on_map")), context);
    if (res != null) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: GlobalAppBar(
          title: widget.locationEntity != null
              ? widget.locationEntity!.address1
              : translate("map.add_location"),
        ...
        body: BlocListener<LocationsBloc, LocationsState>(
            ...
            listener: (ctx, state) {
              ...
              if (state is LocationsFailedState) {
                SnackBarBuilder.showFeedBackMessage(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                              const GoogleMap(
                                initialCameraPosition: CameraPosition(
                                    target: LatLng(21.4504394, 38.8815082),
                                    zoom: 15),
                              ...
                              Padding(
                                ...
                                child: CustomButton(
                                  ...
                                  circular: 10,
                                  widget: CustomText(
                                    text: locationMapEntity == null
                                        ? translate("map.select_on_map")
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (res != null) {
                                      ...
                                      cityTextEditingController.text =
                                          locationMapEntity!.city;
                                      streetTextEditingController.text =
                                          locationMapEntity!.street;
                                      postCodeNumberTextEditingController.text =
                                          locationMapEntity!.postalCode;
                                    }
                                  },
                                ),
                              ),
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: CustomTextFromField(
                              ...
                              radius: 4,
                              textEditingController:
                                  flatNumberTextEditingController,
                              validator: () {},
                              obscureText: false,
                              isLabelError: false),
                        ),
                        SizedBox(
                          ...
                          child: CustomTextFromField(
                              ...
                              radius: 4,
                              textEditingController:
                                  buildingNumberTextEditingController,
                              validator: () {},
                              obscureText: false,
                              isLabelError: false),
                        ),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              border:
                                  Border.all(width: 0, color: DMUtil.getD2C())),
                    ...
                    CustomTextFromField(
                        ...
                        radius: 4,
                        textEditingController:
                            postCodeNumberTextEditingController,
                        validator: () {},
                        obscureText: false,
                        isLabelError: false),
                    ...
                    BlocBuilder<LocationsBloc, LocationsState>(
                      builder: (ctx, state) {
                        ...
                        return CustomButton(
                          ...
                          color: DMUtil.getRED(),
                          onPressed: () async {
                            var type = locationEnum == LocationEnum.Shipping
                                ? "shipping"
                                : "billing";
                            if (locationEnum == LocationEnum.LOCAL) {
                              type = "local";
                            }
                            var phone = phoneTextEditingController.text.trim();
                            if (flatNumberTextEditingController.text
                                    .trim()
                                    .isNotEmpty &&
                                buildingNumberTextEditingController.text
                                    .trim()
                                    .isNotEmpty &&
                                phone.isNotEmpty &&
                                cityTextEditingController.text
                              ...
                              if (widget.locationEntity != null) {
                                if (widget.type == "local") {
                                  locationsBloc.add(AddLocalLocationEvent(
                                      data: data, isUpdate: true));
                                } else {
                                  locationsBloc.add(
                                      UpdateLocationEvent(data: {type: data}));
                                }
                              } else {
                                if (locationMapEntity == null) {
                                ...
                                if (widget.type == "local") {
                                  locationsBloc
                                      .add(AddLocalLocationEvent(data: data));
                                } else {
                                  locationsBloc.add(
                                      AddLocationEvent(data: {type: data}));
                                }
                              }
                            } else {
                              return SnackBarBuilder.showFeedBackMessage(
