    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Image.asset(img,height: 13.h,fit: BoxFit.contain,width: 20.w,),
            CustomText(text: title, color: selected?Colors.white:kText1, fontSize: AppStyle.verySmall.sp,fontWeight: FontWeight.w700,),
