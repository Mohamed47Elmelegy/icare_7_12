                      ...
                      ? ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return MessageTile(
                              ...
                              timeShow: Util.formatTimeToHMPMorAM(
                                      DateTime.parse(data['time'])) +
                                  (Util.isToday(DateTime.parse(data['time']))
                                      ? ''
                                      : "/${Util.formatToDayMonth(DateTime.parse(data['time']))}"),
                            );
                          })
                      : const SizedBox();
                },
                ...
                children: [
                  Expanded(
                    ...
                    child: TextField(
                      ...
                      style: TextStyle(
                          color: DMUtil.getPC(), fontSize: AppStyle.small.sp),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                        ...
                        padding: const EdgeInsets.only(
                            left: 10, top: 8, bottom: 8, right: 7),
                        decoration: BoxDecoration(
  ...
  _sendMsg() async {
    ...
    chatBloc.add(
      SendNewMsgEvent(
          ...
          model: MessageModel(
            text: messageEditingController.text.trim(),
          ...
          catID: null,
          msg: "${Util.getName()}: ${messageEditingController.text.trim()}"),
    );
