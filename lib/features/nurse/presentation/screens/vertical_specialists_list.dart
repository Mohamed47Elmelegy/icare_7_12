...
class AllSpecialistsScreen extends StatelessWidget {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: CustomTextFromField(
                    ...
                    radius: 10,
                    onChanged: (val)=> NurseBloc.get(context).add(UpdateSearchTxtEvent(txt: val.toString().trim())),
