...
class NursePublicationSection extends StatelessWidget {
  const NursePublicationSection({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<NurseBloc,NurseState>(
        builder: (ctx,state){
          ...
          if(currentNurse==null || currentNurse.publicationsList==null)return const SizedBox.shrink();
          var list = currentNurse.publicationsList;
