...
class ApiUrl {
  ...
  static const String UPDATE_USER_PROFILE_STATUS = '${BASE_URL}user/update/status';
  ...
  static const String UPDATE_USER_PASSWORD_PROFILE = '${BASE_URL}auth/password/reset';
  ...
  //publications
  static const String PUBLICATIONS = '${BASE_URL}publications';//publications/{type}
