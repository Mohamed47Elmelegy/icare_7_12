...
class SendGmail {
  ...
  static Future<bool> sendEmailMessage(
      String bodyMsg, String userEmail, String subject) async {
    try {
      final response =
          await http.post(Uri.parse("https://api.smtp2go.com/v3/email/send"),
              body: jsonEncode({
                ...
                // "html_body":html,
                "custom_headers": [
                  {"header": "Reply-To", "value": "Actual Person <$userEmail>"}
                ]
              }));
  ...
  static Future<bool> sendContactUs(
      String title,
      String bodyMsg,
      String userName,
      String lastName,
